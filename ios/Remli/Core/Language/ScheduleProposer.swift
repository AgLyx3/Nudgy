...
struct ScheduleProposer {
    ...
    struct Request {
        ...
        /// Routine the user has told Remli, e.g. "mornings are rough". Never clinical.
    ...
    func propose(
        _ request: Request,
        using model: RemliLanguageModel,
...
extension RemliLanguageModel {
    ...
    func completeRaw(prompt: String) async throws -> String {
        throw RemliModelError.rawCompletionUnsupported
    }
}

enum RemliModelError: Error, LocalizedError {
