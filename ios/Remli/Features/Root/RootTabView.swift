...
struct RemliHeader: View {
    ...
    private var statusTint: Color {
        switch status {
        case .current: return RemliTheme.Palette.primary
        case .attention: return RemliTheme.Palette.concern
        case .needsLook: return RemliTheme.Palette.error
        }
    }
    ...
    var body: some View {
        HStack(spacing: RemliTheme.Metric.sm) {
            ...
            Text("Remli")
                .font(RemliTheme.Typeface.headlineSmall())
                .foregroundStyle(RemliTheme.Palette.primary)
