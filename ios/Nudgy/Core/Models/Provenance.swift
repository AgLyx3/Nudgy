...
///
/// Every clinical statement Nudgy shows carries one of these. There is no way to construct a
...
enum Provenance: Codable, Hashable {
    ...
    /// Nudgy's own scheduling idea. Explicitly not a clinical recommendation.
    ...
    var badgeText: String {
        ...
        case .convenienceSuggestion: return "Nudgy's suggestion"
        }
    }
    ...
    /// True when this represents a fact from the chart rather than something Nudgy inferred.
