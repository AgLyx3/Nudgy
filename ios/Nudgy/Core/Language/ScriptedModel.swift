...
enum NarrationTemplates {
    ...
    /// What Nudgy asks for next. Ordered by how much it matters that the user sees it.
...
/// `NudgyLanguageModel` backed entirely by `NarrationTemplates`.
///
...
final class ScriptedModel: NudgyLanguageModel {
