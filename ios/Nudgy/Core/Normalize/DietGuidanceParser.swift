...
///
/// Nudgy restates. It does not compose. A `NutritionOrder` saying "Diabetic diet" becomes a card
...
/// medication field does: the moment a food claim appears without one, it is Nudgy's claim, and
/// Nudgy has no basis for claims about food.
///
